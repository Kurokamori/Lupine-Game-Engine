/**
 * @file lc_raycast2d.h
 * @brief Lupine Engine C API - RayCast2D Component
 *
 * A 2D ray that queries the physics world every physics frame and reports the
 ...
 * - Immediate re-cast via lc_raycast2d_force_update.
 */

#ifndef LUPINE_CAPI_RAYCAST2D_H
#define LUPINE_CAPI_RAYCAST2D_H
...
/* ============================================================================
 * RayCast2D Component Functions
 * ============================================================================ */

/**
 * @brief Create a RayCast2D component on a node
...
/**
 * @brief Set the bitmask of collision layers the ray is allowed to hit.
 */
LC_API LCResult lc_raycast2d_set_collision_mask(LCComponentHandle handle, uint32_t mask);

/**
 * @brief Get the bitmask of collision layers the ray is allowed to hit.
 */
