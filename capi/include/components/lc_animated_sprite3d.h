/**
 * @file lc_animated_sprite3d.h
 * @brief Lupine Engine C API - AnimatedSprite3D component
 *
 * This header provides functions for 3D animated sprites using sprite animation files.
 * Supports billboarding for always-facing-camera behavior.
 */

#ifndef LUPINE_CAPI_ANIMATED_SPRITE3D_H
#define LUPINE_CAPI_ANIMATED_SPRITE3D_H

#include "core/lc_core.h"
#include "core/lc_node.h"
#include "math/lc_math.h"
#include "components/lc_rendering.h"  /* For LCBillboardMode */
...
/**
 * @brief Create an AnimatedSprite3D component
...
/**
 * @brief Get receive shadows state
 * @param component Component handle
 * @param out_receive Output parameter for receive shadows state
 * @return LC_SUCCESS on success, error code otherwise
 */
LC_API LCResult lc_animated_sprite3d_get_receive_shadows(LCComponentHandle component, bool* out_receive);

/**
 * @brief Set receive shadows state
 * @param component Component handle
...
/**
 * @brief Set double-sided state
 * @param component Component handle
 * @param double_sided Whether to render both sides
 * @return LC_SUCCESS on success, error code otherwise
 */
...
#endif /* LUPINE_CAPI_ANIMATED_SPRITE3D_H */
