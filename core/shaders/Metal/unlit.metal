// Unlit - Metal Shading Language
// Unlit shader with UV rect support
...
fragment float4 fragment_main(
    ...
    float2 uv = mix(uniforms.u_UVRect.xy, uniforms.u_UVRect.zw, in.v_TexCoord);
