// Toon - Metal Shading Language
// Cel/Toon shading with configurable shadow bands, specular bands, and rim lighting
...
fragment float4 fragment_main(
    ...
    float normalScale = uniforms.u_ToonMaterialParams.z;
