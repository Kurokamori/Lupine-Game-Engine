...
#include "../backends/vulkan/GfxDeviceVulkan.hpp"
#include <memory>

namespace lupine {

/**
 * Vulkan implementation of the debug renderer.
 * Provides line, grid, gizmo, and bounding box rendering for the editor.
 */
class DebugRendererVulkan : public DebugRenderer {
public:
    DebugRendererVulkan();
    ~DebugRendererVulkan() override;
