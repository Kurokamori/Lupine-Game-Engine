"""
Add Prefab Dialog
Unity-style dialog for instantiating prefabs
"""
...
class AddPrefabDialog(QDialog):
    """Dialog for instantiating a prefab"""

    # Signal emitted when a prefab is selected
    ...
    def __init__(self, editor_bridge, parent=None):
        ...
        self.setWindowTitle("Instantiate Prefab")
    ...
    def _setup_ui(self):
        ...
        self.search_input.setPlaceholderText("Type to search prefabs...")
        self.search_input.textChanged.connect(self._on_search_changed)
        search_layout.addWidget(search_label)
        search_layout.addWidget(self.search_input)
        layout.addLayout(search_layout)

        # Tree widget for categories and prefabs
        self.tree_widget = QTreeWidget()
        self.tree_widget.setHeaderLabel("Prefabs")
        ...
        self.ok_button = QPushButton("Instantiate")
    ...
    def _build_nested_tree(self, items_with_categories):
        ...
        Args:
            items_with_categories: List of tuples (category_path, item_data)
                                   where category_path is a string like "Characters/NPCs"
    ...
    def _load_prefab_types(self):
        """Load prefab types from the editor bridge and populate the tree"""
    ...
    def _filter_tree_recursive(self, item, search_text):
        ...
        """
        # Check if this is a prefab (has file path data)
        file_path = item.data(0, Qt.ItemDataRole.UserRole)
        type_name = item.data(1, Qt.ItemDataRole.UserRole)
        is_match = False

        if type_name:
            # This is a prefab item
    ...
    def get_selected_path(self):
        """Get the selected prefab file path"""
        return self.selected_path

    def reload_types(self):
        """Reload prefab types from the editor bridge"""
        self._load_prefab_types()
